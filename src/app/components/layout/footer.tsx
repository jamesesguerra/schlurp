        ...
        <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
                <a href="https://flowbite.com" className="flex items-center">
                    <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">schlurp</span>
                </a>
            </div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    <h2 className="mb-6 text-xl tracking-wider font-semibold uppercase text-white font-accent">Resources</h2>
                ...
                <div>
                    <h2 className="mb-6 text-xl tracking-wider  font-semibold uppercase text-white font-accent">Follow us</h2>
                    <ul className="text-gray-400">
                        <li className="mb-4">
